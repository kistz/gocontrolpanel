...
owners_env = os.environ.get('PY_ADMINS', '')

OWNERS = {
  'default': owners_env.split(',') if owners_env else []
}
...
DEDICATED = {
	'default': {
		'HOST': os.environ.get('DEDI_HOST', '127.0.0.1'),
		'PORT': os.environ.get('DEDI_PORT', '5000'),
		'USER': os.environ.get('DEDI_USER', 'SuperAdmin'),
		'PASSWORD': os.environ.get('DEDI_PASS', 'SuperAdmin'),
	}
}
