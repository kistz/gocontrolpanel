...
export default function HetznerDatabaseDetailsModal({
  ...
  const dbData = {
    type: data.labels["database.type"],
    name: data.labels["authorization.database.name"],
    user: data.labels["authorization.database.user"],
    password: data.labels["authorization.database.password"],
  };
    ...
    >
      ...
      <div className="gap-4 grid md:grid-cols-2 md:gap-8">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            <h4 className="text-muted-foreground">Database Info</h4>
            <div className="grid grid-cols-2 gap-2">
              <div className="flex flex-col">
                <span className="font-semibold">Type</span>
                <span className="truncate">{dbData.type || "-"}</span>
              </div>
              <div className="flex flex-col">
                <span className="font-semibold">Name</span>
              ...
              <div className="flex flex-col">
                ...
                <span className="truncate">{dbData.user || "-"}</span>
              </div>
              <div className="flex flex-col">
                <span className="font-semibold">Password</span>
                <span className="truncate">{dbData.password || "-"}</span>
              </div>
            </div>
          </div>
        </div>
